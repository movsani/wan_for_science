...
1. **Diffusion Loss**: Standard denoising diffusion objective on the video latents
2. **Adapter Reconstruction Loss**: Encourages the encode-decode cycle to preserve information
